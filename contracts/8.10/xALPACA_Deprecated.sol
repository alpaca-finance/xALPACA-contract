...
/// @title xALPACA_Deprecated - The deprecated governance vault.
// solhint-disable not-rely-on-time
// solhint-disable contract-name-camelcase
// solhint-disable max-states-count
// solhint-disable avoid-tx-origin
contract xALPACA_Deprecated is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
  ...
  /// @notice Pull ALPACA from xALPACA
  /// @dev This only use to prevent Multichain contagion
  function pull(address _to) external onlyOwner {
    uint256 _amount = IBEP20(token).balanceOf(address(this));
