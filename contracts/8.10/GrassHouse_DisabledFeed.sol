...
/// @title GrassHouse_DisabledFeed - Where Alpaca eats
// solhint-disable not-rely-on-time
// solhint-disable-next-line contract-name-camelcase
contract GrassHouse_DisabledFeed is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
  ...
  function feed(uint256 /*_amount*/) external pure returns (bool) {
    revert("!feed");
  }
